 ...
 * Adapted from React SplashCursor component to Vanilla JS.
 */
(function () {
  const config = {
    SIM_RESOLUTION: 128,
  ...
  class Material {
    ...
    setKeywords(keywords) {
      ...
      if (program == null) {
        ...
        program = createWebglProgram(this.vertexShader, fragmentShader);
  ...
  class Program {
    constructor(vertexShader, fragmentShader) {
      this.uniforms = {};
      this.program = createWebglProgram(vertexShader, fragmentShader);
  ...
  function createWebglProgram(vertexShader, fragmentShader) {
  ...
  // Since we need to call blit before quadBuffer is ready in the original logic, 
  // let's initialize the geometry properly
  ...
  // Pre-initialize geometry once GL is ready
